...
let DiscoveryService = /** @class */ (() => {
    class DiscoveryService extends utils_1.BaseService {
        ...
        updateEndpoints(endpoints) {
            ...
            const endpointsToRemove = lodash_1.default.differenceBy(this.endpoints, endpoints);
            const endpointsToUpdate = lodash_1.default.intersectionBy(this.endpoints, endpoints, getHost);
            lodash_1.default.forEach(endpointsToRemove, (endpoint) => this.emit('remove', endpoint));
            ...
            this.endpoints = lodash_1.default.sortBy(endpointsToUpdate.concat(endpointsToAdd), getHost);
        ...
        async discoverEndpoints(database) {
            ...
            const endpoints = lodash_1.default.map(endpointsResult.endpoints, (endpointInfo) => new Endpoint(endpointInfo, database));
            return lodash_1.default.sortBy(endpoints, (endpoint) => endpoint.toString());
        }
        emit(eventName, ...args) {
